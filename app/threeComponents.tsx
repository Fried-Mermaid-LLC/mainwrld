...
export const AvatarModel: React.FC<{ name: string; activity: string; onClick?: () => void; online: boolean; isPlayer?: boolean; skinColor?: string; }> = ({ name, activity, onClick, online, isPlayer, skinColor }) => {
