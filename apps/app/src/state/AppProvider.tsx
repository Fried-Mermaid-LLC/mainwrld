...
export function useAppValue() {
  ...
  return {
    ...
    setReadingChapterIndex, selectedProfileUser, setSelectedProfileUser, selectedChatUser, setSelectedChatUser, socialListUsername, setSocialListUsername, chatMessages,
    ...
    handleMarkCompleted, handleRequestMonetization, handleSaveDraft, handleCreateBook, handleUpdateBookMeta, handlePublishBook, postComment, handleLikeComment, handleBookProgressUpdate,
